...
# メイン 問題解答生成
for (1..$num_of_eq) {
    my @coeff = gen_num(4, $num_of_rng, 0); # 数字生成
    ...
    # 解答
    $ans = trans_poly($coeff[0]*$coeff[1],$coeff[0]*$coeff[3]+$coeff[1]*$coeff[2],$coeff[2]*$coeff[3]);
